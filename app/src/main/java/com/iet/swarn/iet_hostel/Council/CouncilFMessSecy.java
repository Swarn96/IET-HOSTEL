...
public class CouncilFMessSecy extends AppCompatActivity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        CouncilUserClass messMem1=new CouncilUserClass("","","","",R.drawable.ritik);
//        CouncilUserClass messMem2=new CouncilUserClass("","",""," ",R.drawable.ritik);
//        CouncilUserClass messMem3=new CouncilUserClass("","","","",R.drawable.ritik);
//        CouncilUserClass messMem4=new CouncilUserClass("","","","",R.drawable.ritik);
