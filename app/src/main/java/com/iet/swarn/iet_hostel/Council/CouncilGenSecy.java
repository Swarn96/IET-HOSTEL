...
public class CouncilGenSecy extends AppCompatActivity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        CouncilUserClass genAcSecy=new CouncilUserClass("Mishra Ji","Boys Hostel Guard","9713839105","",R.drawable.mishraji);
//        CouncilUserClass genCulSecy=new CouncilUserClass("","",""," ",R.drawable.ritik);
//        CouncilUserClass genTechSecy=new CouncilUserClass("","","","",R.drawable.ritik);
//        CouncilUserClass genSportSecy=new CouncilUserClass("","",""," ",R.drawable.ritik);
