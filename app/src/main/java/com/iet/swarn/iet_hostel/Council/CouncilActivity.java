...
public class CouncilActivity extends AppCompatActivity
    ...
    private void initCommitteeName() {
        ...
        councilName.add("Hostel Guard");
        councilName.add("Hostel Doctor");
        councilName.add("Hostel Worker");
        councilName.add("Hostel Mess");
        councilName.add("Hostel Sweeper");
        councilName.add("Hostel Gym ");
        councilName.add("Hostel Event TEAM");
