...
public class CouncilWarden extends AppCompatActivity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        CouncilUserClass Asavari=new CouncilUserClass("Vijay Karma","Hostel Warden","9424891320","vkarma@ietdavv.edu.in", R.drawable.vijay_karma);
        CouncilUserClass Bhairavi=new CouncilUserClass("Nagendra Sohani","Hostel Warden","9425311674","nsohani@ietdavv.edu.in",R.drawable.sohani);
      //  CouncilUserClass Abheri=new CouncilUserClass("","","","",R.drawable.ritik);
       // CouncilUserClass Behag=new CouncilUserClass("","","","",R.drawable.ritik);
