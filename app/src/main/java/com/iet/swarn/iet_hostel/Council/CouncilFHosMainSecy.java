...
public class CouncilFHosMainSecy extends AppCompatActivity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        CouncilUserClass groundSecy=new CouncilUserClass("","","","",R.drawable.ritik);
//        CouncilUserClass firstSecy=new CouncilUserClass("","","","",R.drawable.ritik);
//        CouncilUserClass secondSecy=new CouncilUserClass("","","","",R.drawable.ritik);
